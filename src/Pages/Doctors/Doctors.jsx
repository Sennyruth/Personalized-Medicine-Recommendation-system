  ...
  const doctors = [
    {
      ...
      image: process.env.PUBLIC_URL + '/doctors/doctor1.jpg',
    ...
    },
    {
      ...
      image: process.env.PUBLIC_URL + '/doctors/doctor2.jpg',
    ...
    },
    {
      ...
      image: process.env.PUBLIC_URL + '/doctors/doctor3.jpg',
    ...
    },
    {
      ...
      image: process.env.PUBLIC_URL + '/doctors/doctor4.jpg',
    ...
    },
    {
      ...
      image: process.env.PUBLIC_URL + '/doctors/doctor5.jpg',
    ...
    },
    {
      ...
      image: process.env.PUBLIC_URL + '/doctors/doctor6.jpg',
    ...
    <div className="doctors-page">
      ...
      <div className="join-team">
        <div className="join-team-content">
          <h2>Join Our Team</h2>
          <p>
            We're always looking for talented and passionate medical professionals
            to join our team. If you're interested in working with us, please
            get in touch.
          </p>
